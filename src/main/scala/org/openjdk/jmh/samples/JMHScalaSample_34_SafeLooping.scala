...
object JMHScalaSample_34_SafeLooping {

  /*
   * JMHScalaSample_11_Loops warns about the dangers of using loops in @Benchmark methods.
...
class JMHScalaSample_34_SafeLooping {
