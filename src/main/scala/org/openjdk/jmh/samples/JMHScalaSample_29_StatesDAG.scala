...
object JMHScalaSample_29_StatesDAG {
...
@Fork(1)
@State(Scope.Thread)
class JMHScalaSample_29_StatesDAG {

  import JMHScalaSample_29_StatesDAG._
   ...
   * in helper method signatures. (Note that {@link org.openjdk.jmh.samples.JMHScalaSample_28_BlackholeHelpers}
