...
object JMHScalaSample_33_SecurityManager {
  ...
  class SecurityManagerInstalled {
    ...
    @Setup
    def setup(): Unit = {
      val policyFile = classOf[JMHScalaSample_33_SecurityManager].getResource("/jmh-security.policy").toURI()
...
class JMHScalaSample_33_SecurityManager {

  import JMHScalaSample_33_SecurityManager._
